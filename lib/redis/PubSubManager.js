...
export default class PubSubManager {
    ...
    publish(channel, message) {
        this.pusher.publish(channel, EJSON.stringify(message)).catch(console.error);
    }
    ...
    _initChannel(channel) {
        this.listener.subscribe(channel).catch(console.error);
    ...
    _destroyChannel(channel) {
        this.listener.unsubscribe(channel).catch(console.error);
